...
if TYPE_CHECKING:
    ...
    VLLM_TRITON_MLA_SPARSE_PREFILL_BLOCKED_ACCUM: bool = False
    VLLM_TRITON_MLA_SPARSE_PREFILL_BLOCKED_ACCUM_FP32_VALUE: bool = False
    VLLM_TRITON_MLA_SPARSE_PREFILL_FAST_VALUE_MIN_TOKENS: int = 0
    VLLM_TRITON_MLA_SPARSE_PREFILL_BLOCK_C: int = 16
    VLLM_TRITON_MLA_SPARSE_PREFILL_BLOCK_HEADS: int = 8
    VLLM_TRITON_MLA_SPARSE_PREFILL_BLOCK_WARPS: int = 4
    VLLM_TRITON_MLA_SPARSE_PREFILL_BLOCK_STAGES: int = 2
    ...
    VLLM_SM12X_MQA_TOPK_TRITON_LOGITS_ROW_TILED: bool = False
    VLLM_SM12X_MQA_TOPK_TRITON_LOGITS_ROW_TILE: int = 256
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    "VLLM_TRITON_MLA_SPARSE_PREFILL_BLOCKED_ACCUM": lambda: bool(
        env_int_or_default("VLLM_TRITON_MLA_SPARSE_PREFILL_BLOCKED_ACCUM", 0)
    ),
    "VLLM_TRITON_MLA_SPARSE_PREFILL_BLOCKED_ACCUM_FP32_VALUE": lambda: bool(
        env_int_or_default(
            "VLLM_TRITON_MLA_SPARSE_PREFILL_BLOCKED_ACCUM_FP32_VALUE", 0
        )
    ),
    "VLLM_TRITON_MLA_SPARSE_PREFILL_FAST_VALUE_MIN_TOKENS": lambda: (
        env_int_or_default("VLLM_TRITON_MLA_SPARSE_PREFILL_FAST_VALUE_MIN_TOKENS", 0)
    ),
    "VLLM_TRITON_MLA_SPARSE_PREFILL_BLOCK_C": lambda: (
        env_int_or_default("VLLM_TRITON_MLA_SPARSE_PREFILL_BLOCK_C", 16)
    ),
    "VLLM_TRITON_MLA_SPARSE_PREFILL_BLOCK_HEADS": lambda: (
        env_int_or_default("VLLM_TRITON_MLA_SPARSE_PREFILL_BLOCK_HEADS", 8)
    ),
    "VLLM_TRITON_MLA_SPARSE_PREFILL_BLOCK_WARPS": lambda: (
        env_int_or_default("VLLM_TRITON_MLA_SPARSE_PREFILL_BLOCK_WARPS", 4)
    ),
    "VLLM_TRITON_MLA_SPARSE_PREFILL_BLOCK_STAGES": lambda: (
        env_int_or_default("VLLM_TRITON_MLA_SPARSE_PREFILL_BLOCK_STAGES", 2)
    ),
    ...
    "VLLM_SM12X_MQA_TOPK_TRITON_LOGITS_ROW_TILED": lambda: bool(
        int(os.getenv("VLLM_SM12X_MQA_TOPK_TRITON_LOGITS_ROW_TILED", "0"))
    ),
    "VLLM_SM12X_MQA_TOPK_TRITON_LOGITS_ROW_TILE": lambda: env_int_or_default(
        "VLLM_SM12X_MQA_TOPK_TRITON_LOGITS_ROW_TILE", 256
    ),
